...
internal class ModConfigHoverGuideStyleChara : JsonModConfigBase<ModConfigHoverGuideStyleChara>
{
    ...
    [JsonProperty("displayBloodTaste", DefaultValueHandling = DefaultValueHandling.Include)]
    public ModItemDisplayMode DisplayBloodTaste { get; set; } = ModItemDisplayMode.Show;
    ...
    public ModItemDisplayMode DisplayHobby { get; set; } = ModItemDisplayMode.Show;
    ...
    public ModItemDisplayMode DisplayFavorite { get; set; } = ModItemDisplayMode.Show;
