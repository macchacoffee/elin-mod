...
internal static class CharaHoverTextBuilder
{
    private const int _lowValueThreshold = 10;

    private static readonly Dictionary<int, IResistElement> _noneResistElements;
    ...
    static CharaHoverTextBuilder()
    {
        _noneResistElements = EClass.sources.elements.rows
            ...
            .Select(r => new ResistElementMock(r.id, 0, r) as IResistElement)
            .ToDictionary(e => e.Id);
    }
    ...
    public static string BuildHoverText(Chara chara, string text, string text2, string s)
    {
        ...
        return CardHoverTextBuilder.BuildHoverTextSection(hoverText, hoverText2);
    }
    ...
    public static string BuildHoverText2(Chara chara, string text, string text2, string text3)
    {
        ...
        return CardHoverTextBuilder.BuildHoverText(
            CardHoverTextBuilder.BuildHoverTextSection(
    ...
    private static string? GetHoverTextAct(Chara chara)
    {
        ...
        var ptFontSize = ModUIUtil.ComputeFontSize(11);
        var lineFontSize = ModUIUtil.ComputeFontSize(13);
    ...
    private static string? GetHoverTextResist(Chara chara)
    {
        ...
        var resists = StyleConfig.DisplayNoneResistLevel ? new Dictionary<int, IResistElement>(_noneResistElements) : [];
        foreach (var resist in chara.elements
            .ListElements(e => e.source.category == "resist")
            .Select(r => new ResistElementReal(r)))
        {
    ...
    private static string? GetResistListLineText(IEnumerable<IResistElement> resists)
    {
        var lineFontSize = ModUIUtil.ComputeFontSize(13);
    ...
    private static string? GetResistListLineByLevelText(IGrouping<int, IResistElement> group)
    {
    ...
    private static string? GetResistText(IResistElement resist)
    {
