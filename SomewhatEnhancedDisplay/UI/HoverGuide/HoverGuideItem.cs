...
internal class HoverGuideItem
{
    ...
    public HoverGuideItem(WidgetMouseover widget)
    {
    ...
    public bool Show(FontColor fontColor, int fontSize, HoverGuideTarget? target, bool isLocked)
    {
        var displays = false;
